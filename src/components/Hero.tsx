    ...
    <section className="h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 katcakes-container h-full flex flex-col justify-center items-start">
        <div className="max-w-xl animate-fade-in">
          <span className="bg-white px-3 py-1 font-medium text-sm uppercase inline-block mb-4">Confeitaria Caseira</span>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-white mb-4">
            Bolos Artesanais Com Amor
          </h1>
          <p className="text-white/90 text-lg md:text-xl mb-8">
            Deliciosos bolos personalizados e sobremesas feitos com paixão em Maputo. Cada criação conta uma história única.
          </p>
